                    ...
                    <div className="bg-gray-50 border rounded-xl shadow-lg flex flex-col items-center gap-6 p-8 w-4/5 max-w-md relative text-center" onClick={(e) => e.stopPropagation()}>
                        {userData ? (
                            ...
                            <div className="flex flex-col gap-4 w-full items-center">
                                <Link href="/login" onClick={closeMenu} className="text-cyan-900 hover:text-cyan-700 transition duration-300 font-medium text-base bg-cyan-100 px-8 py-3 rounded-lg shadow-sm hover:bg-cyan-200 w-4/5 text-center">
                                    Login
                                </Link>
                                <Link href="/register" onClick={closeMenu} className="text-cyan-900 hover:text-cyan-700 transition duration-300 font-medium text-base bg-cyan-100 px-8 py-3 rounded-lg shadow-sm hover:bg-cyan-200 w-4/5 text-center">
                                    Register
                                </Link>
                            </div>
                        )}
