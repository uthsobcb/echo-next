...
import { Send, User, ArrowLeft, Plus, Loader2 } from 'lucide-react';
...
export default function ChatDetails() {
    ...
    const sendMessage = async (e) => {
        ...
        try {
            ...
            setOldChats(prev => {
                const chatIndex = prev.findIndex(c => c._id === response.data.chatId);
                if (chatIndex >= 0) {
    ...
    return (
        <div className="flex h-screen">
            <Sidebar chats={oldChats} currentChatId={chat?._id} />
