...
export type GrowthOverview = { profile: ReflectionProfileData | null; reports: ReportView[]; activeExperiment: ExperimentView | null };
...
export default function GrowthPage() {
    ...
    const loadOverview = async () => {
        try {
            const response = await axios.get<GrowthOverview>("/api/growth/overview");
